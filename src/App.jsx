      ...
      <div className="arm-root">
        ...
        <div className="main">
          ...
          <aside className="sidebar-left">
            ...
            <div className="action-row" style={{ padding: "0 12px 12px" }}>
              <button className="btn btn-ghost" onClick={resetAll} disabled={estopped || connState !== "connected"}>Reset All</button>
              <button className="btn btn-ghost" onClick={() => publish()} disabled={estopped || connState !== "connected"}>Publish</button>
            </div>
          ...
          <main className="center-panel">
            ...
            {/* Top Grid: Joints + Cartesian/Log side-by-side */}
            ...
            {/* Bottom Section: Full Width Diagnostics */}
            <div className="card" style={{ marginTop: "auto" }}>
              <div className="card-header">
                <span className="card-title">ROS2 Diagnostics</span>
                <span className="card-tag">rosbridge</span>
              </div>
        ...
        <div className="status-strip">
          ...
          <span style={{ marginLeft: "auto", color: "var(--text-dim)" }}>ARM·CTRL v1.6 · {ts()}</span>
        </div>
      </div>
    </>
  );
